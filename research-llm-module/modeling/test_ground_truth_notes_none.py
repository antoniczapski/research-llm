...
models_dir = os.path.join(os.getcwd() ,'models', 'none')
names = os.listdir(models_dir)
data_dir = os.path.join(os.getcwd(),'data', 'processed', 'fineweb_none')
out_dir = os.path.join(os.getcwd(),'reports','none')

# create results csv file
with open(os.path.join(out_dir,"results_ground_none.csv"), "w") as file:
...
for name in tqdm(names):
    try:
        ...
        with open(os.path.join(out_dir,"results_ground_none.csv"), "a") as file:
