...
models_dir = os.path.join(os.getcwd(),'models', 'post')
names = os.listdir(models_dir)
data_dir = os.path.join(os.getcwd(),'data', 'processed', 'fineweb_post')
out_dir = os.path.join(os.getcwd(),'reports','post')

# create results csv file
with open(os.path.join(out_dir,"results_one_max_post.csv"), "w") as file:
...
for name in tqdm(names):
    ...
    # if True:
        ...
        with open(os.path.join(out_dir,"results_one_max_post.csv"), "a") as file:
