...
# I/O
out_dir = os.path.join(os.getcwd(), 'models', 'pl')
eval_interval = 200
log_interval = 1
eval_iters = 200
...
max_iters = 2001 # total number of training iterations
weight_decay = 1e-1
beta1 = 0.9
beta2 = 0.95
...
exec(open(os.path.join(os.getcwd(),'module_experiment_2','configurator.py')).read()) # overrides from command line or config file
